...
('S003', N'Bên Nhau Trọn Đời', N'Cố Mạn', 65000, 10, 4, N'Câu chuyện tình yêu đầy lãng mạn.', N'Văn học', 2010, 300, N'Tiếng Việt', 'https://placehold.co/300x420/e71a22/FFF?text=Ngon+Tinh', 'NCC01', N'NXB Văn Học'),
